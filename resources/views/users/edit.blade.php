				...
				<div class="panel-body">
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="password" name="password" class="form-control" placeholder="Set blank if password not change">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">Password Confirmation</label>
							<div class="col-md-6">
								<input type="passsword" name="password_confirmation" class="form-control" placeholder="Confirm new password">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								{!! Form::select('role', ['1' => 'Active', '0'=> 'Non Active'], [], ['class' => 'form-control']) !!}
							</div>
						</div>
						<div class="form-group">
